#ifndef ALBUMHANDLER_H
#define ALBUMHANDLER_H

#include "gerdabServer.hpp"
#include "api.hpp"
#include <iostream>

class albumHandler: public RequestHandler{
